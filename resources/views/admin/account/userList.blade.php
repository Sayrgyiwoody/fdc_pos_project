...
@section('content')
    ...
    <div class="main-content">
        {{-- Header --}}
        @section('header')
        <form class="form-header" action="{{route('admin#userAccountList')}}" method="get">
            <input class="au-input au-input--xl" type="text" name="searchKey" value="{{request('searchKey')}}" placeholder="Search for user name..." />
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">User Account List</h2>
                            </div>
