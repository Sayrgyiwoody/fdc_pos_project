                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" novalidate="novalidate" >
                                ...
                                <div class="form-group mt-3">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-lg-1 fs-4 me-3 d-flex px-2">
                                                    <label for="control-label" class="text-center my-auto"><i class="fa-solid fa-phone me-2"></i></label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <input readonly disabled type="text" name="" class="form-control form-control-sm border-0 border-bottom border-dark   bg-white" value="{{Auth::user()->phone}}" id="">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-lg-1 fs-4 me-3 d-flex px-2">
                                                    <label for="control-label" class="text-center my-auto"><i class="fa-solid fa-calendar me-2"></i></label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <input readonly disabled type="text" name="" class="form-control form-control-sm border-0 border-bottom border-dark   bg-white" value="{{Auth::user()->created_at->format('j-F-Y')}}" id="">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-lg-1 fs-4 me-3 px-2">
                                                    <label for="control-label" class="text-center my-auto"><i class="fa-solid fa-location-dot me-2"></i></label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <textarea readonly disabled name="" id="" cols="" rows="2" class="form-control form-control-sm border-0 border-bottom border-dark   bg-white">{{Auth::user()->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="float-end me-5 mt-2">
                                    <a href="{{route('category#list')}}" class="btn btn-secondary"><i class="fa-solid fa-arrow-left me-2"></i>Back</a>
