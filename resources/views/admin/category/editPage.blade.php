...
@section('content')
    ...
    <div class="main-content">
        <!-- HEADER DESKTOP-->
        @section('header')
        <h4>Admin Category Edit Page</h4>
        @endsection
        <!-- HEADER DESKTOP-->
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('category#update',$category->id)}}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="categoryName" value="{{old('categoryName',$category->name)}}" type="text" class="form-control @error('categoryName') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Category...">
                                    @error('categoryName')
